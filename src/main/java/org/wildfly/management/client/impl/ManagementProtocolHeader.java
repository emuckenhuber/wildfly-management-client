...
abstract class ManagementProtocolHeader {
    ...
    public static ManagementProtocolHeader parse(DataInput input) throws IOException {
        ...
        StreamUtils.expectHeader(input, ManagementProtocol.VERSION_FIELD);
        int version = input.readInt();
        StreamUtils.expectHeader(input, ManagementProtocol.TYPE);
    ...
    static class ManagementByeByeHeader extends ManagementProtocolHeader {
    ...
    static class ManagementPingHeader extends ManagementProtocolHeader {
    ...
    static class ManagementPongHeader extends ManagementProtocolHeader {
